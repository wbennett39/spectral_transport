...
# square_IC_converge(moving_mesh=False, uncollided=False, M=2, N_space_list=[15, 30, 60], N_ang =32, run_results = True, ang_method='diamond')
# square_IC_converge(moving_mesh=False, uncollided=False, M=2, N_space_list=[15, 30, 60], N_ang =64, run_results = True, ang_method='diamond')
square_IC_converge(moving_mesh=False, uncollided=False, M=2, N_space_list=[120, 240], N_ang =96, run_results = True, ang_method='diamond')
square_IC_converge(moving_mesh=False, uncollided=False, M=2, N_space_list=[15, 30, 60], N_ang =128, run_results = True, ang_method='diamond')
square_IC_converge(moving_mesh=False, uncollided=False, M=2, N_space_list=[15, 30, 60], N_ang =256, run_results = True, ang_method='diamond')
